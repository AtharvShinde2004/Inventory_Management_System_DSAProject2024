...
public class AList<T> implements ListInterface<T> {
    ...
    public Iterator<T> getIterator() {
        return new AListIterator<T>(this);
    }
    ...
    public class AListIterator<T> implements Iterator<T> {
        ...
        public AListIterator(AList<T> list) {
            this.list = list;
        }
        ...
        public boolean hasNext() {
            if (currentIndex <= list.getLength()) {
                while (list.getEntry(currentIndex) == null && currentIndex < list.getLength()) {
                    currentIndex++;
                }
            }
        ...
        public T next() {
            ...
            return list.getEntry(currentIndex++);
        }

        // Optional: Implement remove() if needed (not required for basic usage)
        @Override
        public void remove() {
